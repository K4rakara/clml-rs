...
pub fn clml(target: &str) -> String {
    ...
    for k in REPLACEMENTS.keys() {
        ...
        to_return = regex
            .replace_all(&to_return, NoExpand(REPLACEMENTS.get(k).unwrap()))
            .to_string();
    }
    ...
    // Do 256 color replacements.
    {
        ...
        to_return = regex
            .replace_all(&to_return, |capture: &Captures| {
...
mod tests {
    ...
    fn color_rgb() {
        assert_eq!(
            "\u{001b}[38;2;255;255;255mHi\u{001b}[0m",
            clml("<rgb 255 255 255>Hi<reset>")
        );
    }
    #[test]
    fn movement() {
