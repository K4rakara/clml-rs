...
mod tests {
    #[test]
    fn simple() {
        assert_eq!("\u{001b}[31mHi\u{001b}[0m", super::clml("<red>Hi<reset>"));
    }
    #[test]
    fn color_255() {
        assert_eq!("\u{001b}[38;5;10mHi\u{001b}[0m", super::clml("<255 10>Hi<reset>"));
    }
    #[test]
    fn color_rgb() {
        assert_eq!("\u{001b}[38;2;255;255;255mHi\u{001b}[0m", super::clml("<rgb 255 255 255>Hi<reset>"));
    }
    #[test]
    fn emoji() {
        assert_eq!("😄", super::clml("<:smile:>"));
    }
}
